    ...
    public class ExtentReport
    {
        ...
        public static ExtentTest Test
        {
            get
            {
                ...
                throw new InvalidOperationException($"ExtentTest has not been created for test id: {testId}. Please call ExtentReport.CreateTest() in [SetUp] before logging.");
            }
        }
        ...
        public static void InitReport()
        {
            lock (_lock)
            {
                ...
                var reportPath = Path.Combine(reportFolder,$"TestResult{DateTime.Now:yyyyMMdd_HHmmss}.html");
                var sparkReporter = new ExtentSparkReporter(reportPath);

                _extent = new ExtentReports();
                _extent.AttachReporter(sparkReporter);

                _extent.AddSystemInfo("Project", "Test Automation Reqnroll");
